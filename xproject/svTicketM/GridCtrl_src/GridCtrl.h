...
public:
	...
	void SetScrollNoDisable(int nbar, bool val) {
		if (nbar == SB_HORZ)
		{
			m_hscrool_no_disable = val;
			EnableScrollBars(nbar, TRUE); 
		}
		else if(nbar == SB_VERT)
		{
			m_vscrool_no_disable = val;
			EnableScrollBars(nbar, TRUE); 
		}
	};
private:
	bool m_vscrool_no_disable;
	bool m_hscrool_no_disable;
///////////////////////////////////////////////////////////////////////////////////
// Attributes
///////////////////////////////////////////////////////////////////////////////////
public:
